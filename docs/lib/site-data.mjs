...
export const SITE = {
  ...
  productSummary:
    "Lamina is an open-source skill licensed under Apache-2.0 that designs product behavior before your coding agent ships app source. UI skills dress the app; Lamina designs how it behaves — states, roles, flows, edge cases, and permission matrices.",
