...
| Personas | `.lamina/personas.json` |
| Machine contract | `.lamina/runs/havenstay-platform-2026-07-10/run.json` |
...
<Callout type="info">
**Advanced:** The HavenStay `run.json` includes 15+ entities, 30+ workflows, and a full dependency graph. Use it as a reference when authoring your own contracts.
</Callout>
...
- [Quickstart](/getting-started/quickstart) — run your own cycle
- [run.json schema](/reference/run-json-schema) — study the HavenStay contract structure
