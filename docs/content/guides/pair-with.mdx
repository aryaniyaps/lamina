...
Lamina is unopinionated on framework, database, and UI library. See [Any stack](/concepts/what-is-lamina#any-stack) for the full compatibility table.

## Deeper guides

- [Pair with UI skills](/guides/pair-with-ui-skills) — behavior vs pixels
- [Pair with Spec Kit](/guides/pair-with-spec-kit) — product contract before engineering plans
...
- [Pair with UI skills](/guides/pair-with-ui-skills)
- [Pair with Spec Kit](/guides/pair-with-spec-kit)
