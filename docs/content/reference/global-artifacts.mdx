...
- [/lamina-init command](/commands/lamina-init) — how to bootstrap domain context
- [Personas concept](/concepts/personas) — how actors drive verification
- [Per-run artifacts](/reference/artifacts) — files inside `.lamina/runs/<id>/`
