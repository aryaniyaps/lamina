...
| One public skill contains the complete module set | `skills/lamina` plus 58 modules under `skills/lamina/skills` | `verify_lamina_bundle.mjs`, `eval_install_all_skills_test.mjs` |
...
and the distribution decision in
[ADR-002](https://github.com/aryaniyaps/lamina/blob/main/docs/decisions/002-single-public-skill-bundle.md).
