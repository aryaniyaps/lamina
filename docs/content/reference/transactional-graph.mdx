---
title: Transactional graph model
description: Canonical storage, typed graph records, GraphVersions, observations, Missions, and epistemic boundaries.
---
...
See the [CLI reference](/commands), [validation](/reference/validation), and [storage and backups](/reference/artifacts).
