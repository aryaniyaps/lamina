...
Lamina includes ~60 capability skills organized into three taxonomies. The orchestrator routes design and verify sections to the right skill via [audit profiles](/docs/advanced/orchestrator).
...
- [/lamina command](/docs/commands/lamina) — router and direct mode
- [Orchestrator](/docs/advanced/orchestrator) — how skills are coordinated
