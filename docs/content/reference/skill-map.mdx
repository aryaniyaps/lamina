---
title: Installed capability skills
description: Capability lenses the Lamina orchestrator uses while graphd retains canonical authority.
---

import { Callout } from 'nextra/components'

# Installed capability skills

Lamina includes capability skills organized into three taxonomies. They help the orchestrator reason about a proposal; they do not own canonical state or bypass graph validation.
