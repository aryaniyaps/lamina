...
See [Global artifacts](/reference/global-artifacts) for field-level detail.
...
- [Global artifacts](/reference/global-artifacts) — `business-context.md` and `personas.yaml` reference
