...
<Callout type="info">
**Advanced:** Brownfield verify may infer domain from repo and walkthrough without a prior design run. See [Brownfield and greenfield](/docs/concepts/brownfield-and-greenfield).
</Callout>
...
- [Personas](/docs/concepts/personas) — how actor walks work
- [Troubleshooting](/docs/getting-started/troubleshooting) — common verify issues
