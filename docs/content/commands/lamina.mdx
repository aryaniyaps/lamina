...
Direct mode skills cover systems thinking, UX, and agent simulation topics. See [Skill map](/docs/reference/skill-map) for the full list.
...
Only `.lamina/` artifacts. Never app source. See [Guardrails](/docs/concepts/the-loop#ownership) and [Contracts and runs](/docs/concepts/contracts-and-runs).

## Next steps

- [/lamina-init](/docs/commands/lamina-init) — bootstrap domain context
- [/lamina-design](/docs/commands/lamina-design) — design a contract
- [/lamina-verify](/docs/commands/lamina-verify) — verify the live build
