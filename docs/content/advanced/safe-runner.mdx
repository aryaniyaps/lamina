...
executable. Model bytes, size, and digest must match the canonical retrieval
...
ceiling. Inherited `LAMINA_TEST_*` controls are removed for non-self-test
payloads, and retrieval semantic environment names are stripped before launch.
