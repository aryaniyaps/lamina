...
<Callout type="info">
**Advanced:** `run.yaml` is the machine contract — not metadata. It contains entities, workflows, scenarios, dependencies, and findings. See [run.yaml schema](/docs/reference/run-yaml-schema).
</Callout>
...
See [Global artifacts](/docs/reference/global-artifacts) and [Per-run artifacts](/docs/reference/artifacts) for field-level detail.
...
- [Per-run artifacts](/docs/reference/artifacts) — file-by-file reference
- [The loop](/docs/concepts/the-loop) — design → implement → verify workflow
