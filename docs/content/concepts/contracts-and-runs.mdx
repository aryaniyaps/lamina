...
2. `/lamina-design` creates `.lamina/runs/<id>/` with `run.json` and `implement.md`
...
| Per-run | `run.json`, `implement.md`, `fix.md`, `report.md`, `walkthrough/` | `/lamina-design`, `/lamina-verify` |
