...
Spec Kit, Kiro, and spec-driven dev structure engineering work. Lamina structures **product behavior**. Run `/lamina-init`, then `/lamina-design`, then feed `implement.md` into Spec Kit. See [Pair with Spec Kit](/guides/pair-with-spec-kit).
