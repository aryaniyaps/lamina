...
<Callout type="info">
  **Not uselamina.ai.** Lamina ([lamina.dev](https://lamina.dev)) is an open-source product-design skill for AI coding agents. It is not affiliated with [uselamina.ai](https://uselamina.ai), a separate creative API for media generation.
</Callout>
