...
See [Global artifacts](/reference/global-artifacts) for the full field reference.
...
- [Global artifacts](/reference/global-artifacts) — `personas.yaml` reference
- [/lamina-verify](/commands/lamina-verify) — run persona walks
- [Demo: HavenStay](/guides/demo-havenstay) — concrete examples
