...
3. **Do not** auto-run `/lamina-init` — the user must invoke it explicitly.
4. Emit the blocked output contract — prompt `outputs/init-blocked.md`.
5. List specific validation failures under **What's missing**.
