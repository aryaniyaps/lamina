...
9. Merge into narrative contract — prompt `outputs/audit`. Write `runs/<run_id>/report.md`. Run `lamina-studio validate run .lamina/runs/<run_id>/run.yaml`. On conflicts, append to global `decisions.md` with `run_id`.
