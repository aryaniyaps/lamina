...
6. Append or update audited flows in `.lamina/flows-inventory.yaml` (`status: shipped`) per [artifacts.md](../artifacts.md). Write simulation results to `.lamina/personas/simulations/<run_id>.yaml` when panel runs.
