...
Do not collapse these kinds into one timestamp. Attach Statements to the
relevant Entity/Operation attributes naming the kind, owning actor or place,
accepted input, authoritative representation, display policy, and correction
path.
