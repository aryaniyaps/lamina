...
description: "Product Behavior UX guidance. Use when defining product behavior before build; UI mirrors database or org structure; behavior-first design process."
metadata:
  lamina:
    id: product-behavior
    problems:
