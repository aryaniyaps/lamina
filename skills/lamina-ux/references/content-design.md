...
Specify **user-visible text** as Statements on Surface, Operation, and Scenario
Resources—labels, headings, errors, and empty states—so implementation and
Mission verification query one source of truth.
...
3. Labels use canonical Entity aliases and actor vocabulary, not internal jargon.
