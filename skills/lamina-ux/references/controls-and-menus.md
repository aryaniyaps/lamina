...
For each Operation realized by a Surface:
...
1. Destructive Operations link to Scenario and recovery/undo Statements.
...
5. Platform-convention decisions are graph facts surfaced in the implementation
   projection; Lamina stays unopinionated on library.
