...
description: "Platform Posture UX guidance. Use when choosing product density and stance; sovereign vs transient vs augmentation; platform attention mismatch."
metadata:
  lamina:
    id: platform-posture
    problems:
