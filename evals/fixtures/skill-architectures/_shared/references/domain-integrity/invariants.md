...
> Migrated intact from `skills/lamina-invariants/SKILL.md` at `9a02ad51bbd294e3ee2ee1fd605f366297b9c43b`.
...
**Invariants vs dependencies:** Invariants are predicates that must hold in valid states. Dependencies are reachability edges — what must exist before a workflow can succeed. Do not collapse them; use Dependencies for cross-feature setup.
