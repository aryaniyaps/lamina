...
**Unattended trial:** the user cannot answer. Build the product in the brief — not a benchmark harness. During implement/fix, finish the full product in this session — do not wait for proceed, do not stop at a scaffold or task list.
