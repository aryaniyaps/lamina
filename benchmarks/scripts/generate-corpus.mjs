#!/usr/bin/env node
/**
 * Generate LaminaBench v1.1 task corpus (25 tasks + goldens).
...
- Must work offline for viewing balances`,
    golden: {
      ...
      required_sections: ['users and jobs', 'flows', 'accessibility', 'metrics and validation'],
    },
  },
  {
    id: 'task002',
...
- English and Spanish at launch`,
    golden: {
      ...
      required_sections: ['users and jobs', 'journey and information architecture', 'flows', 'edge cases', 'accessibility'],
    },
  },
  {
    id: 'task003',
...
- Free tier for small nonprofits`,
    golden: {
      ...
      required_sections: ['users and jobs', 'flows', 'edge cases'],
    },
  },
  {
    id: 'task004',
...
- Premium: unlimited trips and expense export`,
    golden: {
      ...
      required_sections: ['users and jobs', 'journey and information architecture', 'flows'],
    },
  },
  {
    id: 'task005',
...
- Privacy-first social features`,
    golden: {
      ...
      required_sections: ['users and jobs', 'flows', 'interactions', 'accessibility'],
    },
  },
  // OSS Feature (5)
  {
...
Core UX: left sidebar navigation, issue states, cycles, modules, Kanban/List views.`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'risks and decisions', 'accessibility'],
    },
  },
  {
    id: 'task007',
...
Existing flows: product listing, product detail, cart, checkout.`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'metrics and validation'],
    },
  },
  {
    id: 'task008',
...
Existing: collection-level permissions, @mentions, inline comments.`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'risks and decisions'],
    },
  },
  {
    id: 'task009',
...
- Accessible from account settings and search bar`,
    ...
    golden: {
      ...
      required_sections: ['flows', 'edge cases'],
    },
  },
  {
    id: 'task010',
...
- Clear feedback on partial failures`,
    ...
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'error handling'],
    },
  },
  // OSS Audit (5)
  {
    ...
    human_eval: true,
    oss: { repo: 'vercel/commerce', commit: 'main' },
    prompt: 'Audit the checkout flow for usability issues.',
    description: `# Checkout Flow Audit

Perform a UX audit of the storefront checkout flow.
...
Review the codebase and existing flows inventory in .lamina/ if present.`,
    golden: {
      ...
      required_findings: ['form_validation', 'progress_indication', 'error_recovery', 'trust_signals', 'mobile_usability'],
      ...
      required_sections: ['executive summary', 'findings', 'prioritized improvements'],
    },
  },
  {
    id: 'task012',
...
Audit the UX of project settings and configuration in Plane.
...
- Integration settings`,
    ...
    golden: {
      ...
      required_findings: ['discoverability', 'destructive_action_guards', 'settings_organization', 'permission_clarity'],
      required_edge_cases: ['last_admin_removal', 'invalid_invite', 'settings_conflict'],
      required_a11y: ['settings_navigation', 'toggle_labels'],
      required_sections: ['executive summary', 'findings', 'quick wins'],
    },
  },
  {
    id: 'task013',
    ...
    human_eval: false,
    oss: { repo: 'outline/outline', commit: 'main' },
    prompt: 'Audit document sharing and permissions UX in Outline.',
...
- Permission inheritance and conflicts`,
    ...
    golden: {
      ...
      required_findings: ['permission_confusion', 'inheritance_clarity', 'share_discoverability', 'revocation'],
  ...
  },
  {
    ...
    human_eval: false,
    oss: { repo: 'vercel/commerce', commit: 'main' },
    prompt: 'Audit the cart experience for friction and abandonment risks and decisions.',
...
- Price updates and out-of-stock handling`,
    ...
    golden: {
      ...
      required_findings: ['add_to_cart_feedback', 'cart_persistence', 'price_transparency', 'mobile_cart'],
...
- Initial issue creation`,
    ...
    golden: {
      ...
      required_findings: ['time_to_value', 'empty_state_guidance', 'skip_options', 'progress_indication'],
...
- Prior auth may take 24–72 hours`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'business rules'],
    },
  },
  {
    id: 'task017',
...
- Multi-currency for travel`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'state management'],
    },
  },
  {
    id: 'task018',
...
- SSO group mapping`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'policy enforcement'],
    },
  },
  {
    id: 'task020',
...
- Compliance training required before system access`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'recovery flows'],
    },
  },
...
- Mobile and desktop clients`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'accessibility', 'recovery paths'],
    },
  },
  {
    id: 'task022',
...
- Real-time data updates`,
    golden: {
      ...
      required_sections: ['accessibility', 'flows', 'metrics and validation'],
    },
  },
  {
    id: 'task023',
...
- Localization support`,
    golden: {
      ...
      required_sections: ['flows', 'interactions and copy', 'accessibility'],
    },
  },
  {
    id: 'task024',
...
- SSO with Okta`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'recovery paths'],
    },
  },
  {
    id: 'task025',
...
- Offline-first read cache`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'user guidance'],
    },
  },
];
