...
- Must work offline for viewing balances`,
    golden: {
      ...
      required_sections: ['user model', 'flows', 'accessibility', 'validation plan'],
    },
  },
  {
    id: 'task002',
...
- English and Spanish at launch`,
    golden: {
      ...
      required_sections: ['user model', 'journeys', 'flows', 'edge cases', 'accessibility'],
    },
  },
  {
    id: 'task003',
...
- Free tier for small nonprofits`,
    golden: {
      ...
      required_sections: ['user model', 'flows', 'edge cases'],
    },
  },
  {
    id: 'task004',
...
- Premium: unlimited trips and expense export`,
    golden: {
      ...
      required_sections: ['user model', 'information architecture', 'flows'],
    },
  },
  {
    id: 'task005',
...
- Privacy-first social features`,
    golden: {
      ...
      required_sections: ['user model', 'flows', 'interactions', 'accessibility'],
    },
  },
  // OSS Feature (5)
  {
...
Core UX: left sidebar navigation, issue states, cycles, modules, Kanban/List views.`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'risks', 'accessibility'],
    },
  },
  {
    id: 'task007',
...
Existing flows: product listing, product detail, cart, checkout.`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'success metrics'],
    },
  },
  {
    id: 'task008',
...
Existing: collection-level permissions, @mentions, inline comments.`,
    golden: {
      ...
      required_sections: ['flows', 'edge cases', 'risks'],
    },
  },
  {
    id: 'task009',
...
- Permission inheritance and conflicts`,
  ...
  },
  {
    ...
    human_eval: false,
    oss: { repo: 'vercel/commerce', commit: 'main' },
    prompt: 'Audit the cart experience for friction and abandonment risks.',
...
- Real-time data updates`,
    golden: {
      ...
      required_sections: ['accessibility', 'flows', 'validation plan'],
    },
  },
  {
    id: 'task023',
...
- Localization support`,
    golden: {
      ...
      required_sections: ['flows', 'copy guidance', 'accessibility'],
    },
  },
  {
    id: 'task024',
